let data = [
	{
		content: {title1: 'พื้นฐานที่ควรรู้ก่อนสร้างเว็บ',title2: 'มาสร้างเว็บไซต์แรกของเรากันเลย',title3: 'มาเล่นกับสารพัด Tag',title4: 'ทำให้เว็บออนไลน์',title5: 'แบบฝึกหัด',},
		author: 'เอกพิชา',authorRef: '3',date: '12/05/2023',title: 'Introduction to HTML',id: '01',
	...
	{
		content: {title1: 'แต่งเว็บไซต์ให้เก๋ขึ้น แค่รู้จัก CSS',title2: 'ทำให้เว็บหลุดกรอบด้วย CSS3',title3: 'ทำเว็บให้สวยขึ้นเป็นพันเท่าด้วย Bootstrap',title4: 'แบบฝึกหัด',},
	    author: 'เอกพิชา',date: '12/05/2023',title: 'Introduction to CSS',id: '02',
	...
	{
		content: {title1: 'สิ่งที่ควรรู้ก่อนเริ่มต้นกับ JavaScript',title2: 'พื้นฐานการใช้งาน JavaScript เบื้องต้น',title3: 'พื้นฐานการตัดสินใจของโปรแกรม',title4: 'แบบฝึกหัด',},
		author: 'เอกพิชา',date: '12/05/2023',title: 'Introduction to JavaScript',id: '03',
	...
	{
		content: {title1: 'เตรียมใช้งาน React',title2: 'React JSX',title3: 'React Components',title4: 'React Props',title5: 'React State',title6: 'แบบฝึกหัด',},
		author: 'เอกพิชา',date: '12/05/2023',title: 'Introduction to React',id: '04',
	...
	{
		content: {title1: 'JSON ประกอบด้วยอะไรบ้าง',title2: 'JSON แตกต่างจาก XML อย่างไร',title3: 'โค้ดตัวอย่างการใช้งาน',title4: 'แบบฝึกหัด',},
		author: 'เอกพิชา',date: '12/05/2023',title: 'Introduction to JSON',id: '05',
	...
	{
		content: {title1: 'Docker มันทำงานยังไง',title2: 'Docker มันคืออะไร',title3: 'ตัวอย่างการใช้งาน',title4: 'แบบฝึกหัด',},
		author: 'เอกพิชา',date: '12/05/2023',title: 'Introduction to Docker',id: '06',
	...
	{
		content: {title1: 'แนะนำการเริ่มต้นกับ Python 3',title2: 'ทำความรู้จักกับข้อมูล และ การแสดงผลข้อมูล',title3: 'รู้จักกับตัวแปร และ ตัวดำเนินการ',title4: 'รู้จักการทำงานแบบวนซ้ำในการพัฒนาโปรแกรม',title5: 'รู้จักกับฟังก์ชัน',title6: 'รู้จักให้ลึกขึ้นกับ String',title7: 'การพัฒนาโปรแกรมเชิงวัตถุเบื้องต้น',title8: 'แบบฝึกหัด',},
		author: 'เอกพิชา',date: '12/05/2023',title: 'Introduction to Python',id: '07',
...
let Products1 = {
    ...
    findAndUpdate: (id, product1, newItem=true) => {
        return new Promise((resolve, reject) => {
            let index = data.findIndex(e=> e.id === id);
            if (index < 0)
            ...
            else data.splice(index, 1, product1)
            resolve(data[index])
        }
    )},
    insert: (product1) => {
